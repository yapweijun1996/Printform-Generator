      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-hide bg-white/50">
        {messages.length === 0 && (
          <div className="h-full flex flex-col items-center justify-center text-erp-400 opacity-60 p-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mb-3 text-erp-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
            </svg>
            <p className="text-xs text-center leading-relaxed">
                Describe the invoice or report you need.<br/>
            ...
            <div className="mb-2 relative inline-block">
                <div className="relative group">
                    <img 
                        ...
                        alt="Preview" 
                        className="h-16 rounded border border-erp-300 shadow-sm"
                    />
                    <button 
                        onClick={() => {
                            setSelectedImage(null);
