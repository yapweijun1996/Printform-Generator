      ...
      <div className="flex-1 overflow-y-auto p-2">
        <div className="space-y-1">
            {files.map(file => (
                ...
                >
                    <div className={`p-1.5 rounded ${activeFileId === file.id ? 'bg-blue-200 text-blue-700' : 'bg-erp-100 text-erp-400 group-hover:bg-white'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[10px] text-erp-400 truncate">
