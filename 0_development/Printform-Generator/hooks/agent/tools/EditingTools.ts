...
const getAnchorNotFoundError = (anchor: string) => {
...
export const modifyCodeTool: Tool = {
  name: 'modify_code',
  friendlyName: 'Modify Code',
  statusText: 'Applying code changes...',
...
export const insertContentTool: Tool = {
  name: 'insert_content',
  friendlyName: 'Insert Content',
  statusText: 'Inserting new content...',
  isConcurrencySafe: false,
  isDestructive: true,
...
export const undoLastTool: Tool = {
  name: 'undo_last',
  friendlyName: 'Undo Last',
  statusText: 'Reverting last change...',
  isConcurrencySafe: false,
  isDestructive: true,

  async call(_args: any, context: ToolContext): Promise<ToolResult> {
    const ok = context.revertToLatestHistory();
    return ok
