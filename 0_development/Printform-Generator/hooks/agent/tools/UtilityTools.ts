...
import { findFuzzyMatch } from './EditingTools';
import { PRINTFORM_REFERENCE_TEMPLATES } from '../../../constants';

export const diffCheckTool: Tool = {
  name: 'diff_check',
  friendlyName: 'Diff Check',
  statusText: 'Previewing diff...',
  isConcurrencySafe: true,
  isDestructive: false,

  async call(args: any, context: ToolContext): Promise<ToolResult> {
    const currentContent = context.getActiveFile().content;
...
export const printSafeValidatorTool: Tool = {
  name: 'print_safe_validator',
  friendlyName: 'Print-Safe Validator',
  statusText: 'Validating print-safe rules...',
  isConcurrencySafe: true,
  isDestructive: false,
...
export const htmlValidationTool: Tool = {
  name: 'html_validation',
  friendlyName: 'HTML Validator',
  statusText: 'Validating strict HTML...',
  isConcurrencySafe: true,
  isDestructive: false,
...
export const loadReferenceTemplateTool: Tool = {
  name: 'load_reference_template',
  friendlyName: 'Load Template',
  statusText: 'Loading reference template...',
  isConcurrencySafe: true,
  isDestructive: false,
