var PrintForm = (function () {
    ...
    if (numberTargets.length === 0 && totalTargets.length === 0) {
      ...
      if (fallback) {
        fallback.textContent =
          totalPages !== void 0 && totalPages !== null
  ...
  const CONFIG_DESCRIPTORS = [
    ...
    },
    {
      ...
      legacyKey: 'repeat_docinfo',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatDocinfo002',
      datasetKey: 'repeatDocinfo002',
      legacyKey: 'repeat_docinfo002',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatDocinfo003',
      datasetKey: 'repeatDocinfo003',
      legacyKey: 'repeat_docinfo003',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatDocinfo004',
      datasetKey: 'repeatDocinfo004',
      legacyKey: 'repeat_docinfo004',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatDocinfo005',
      datasetKey: 'repeatDocinfo005',
      legacyKey: 'repeat_docinfo005',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
    ...
    },
    {
      ...
      legacyKey: 'repeat_footer',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatFooter002',
      datasetKey: 'repeatFooter002',
      legacyKey: 'repeat_footer002',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatFooter003',
      datasetKey: 'repeatFooter003',
      legacyKey: 'repeat_footer003',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatFooter004',
      datasetKey: 'repeatFooter004',
      legacyKey: 'repeat_footer004',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatFooter005',
      datasetKey: 'repeatFooter005',
      legacyKey: 'repeat_footer005',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
    ...
    },
    {
      ...
      legacyKey: 'repeat_footer_pagenum',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    {
  ...
  function getPrintformConfig(formEl, overrides = {}) {
    ...
    merged.customDummyRowItemContent = resolveTemplateOverride(
      formEl,
      overrides.customDummyRowItemContent !== void 0
    ...
    const manualWidthProvided =
      Object.prototype.hasOwnProperty.call(legacy, 'papersizeWidth') ||
      Object.prototype.hasOwnProperty.call(datasetConfig, 'papersizeWidth') ||
      overrideHas('papersizeWidth');
    const manualHeightProvided =
      Object.prototype.hasOwnProperty.call(legacy, 'papersizeHeight') ||
      Object.prototype.hasOwnProperty.call(datasetConfig, 'papersizeHeight') ||
      overrideHas('papersizeHeight');
    if (!manualWidthProvided && !manualHeightProvided) {
      const resolved = resolvePaperDimensions({
  ...
  const PADDT_CONFIG_DESCRIPTORS = [
    ...
    },
    {
      ...
      legacyKey: 'insert_paddt_dummy_row_items',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      ...
      legacyKey: 'paddt_max_words_per_segment',
      defaultValue: 200,
      parser: parseNumber,
    },
    {
      ...
      legacyKey: 'repeat_paddt_rowheader',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      ...
      legacyKey: 'paddt_debug',
      defaultValue: false,
      parser: parseBooleanFlag,
    },
    // PADDT-specific docinfo toggles (show/hide on PADDT pages only)
    {
      key: 'repeatPaddtDocinfo',
      datasetKey: 'repeatPaddtDocinfo',
      legacyKey: 'repeat_paddt_docinfo',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatPaddtDocinfo002',
      datasetKey: 'repeatPaddtDocinfo002',
      legacyKey: 'repeat_paddt_docinfo002',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatPaddtDocinfo003',
      datasetKey: 'repeatPaddtDocinfo003',
      legacyKey: 'repeat_paddt_docinfo003',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatPaddtDocinfo004',
      datasetKey: 'repeatPaddtDocinfo004',
      legacyKey: 'repeat_paddt_docinfo004',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
    {
      key: 'repeatPaddtDocinfo005',
      datasetKey: 'repeatPaddtDocinfo005',
      legacyKey: 'repeat_paddt_docinfo005',
      defaultValue: true,
      parser: parseBooleanFlag,
    },
  ];
  ...
  function getPaddtConfig(formEl, overrides) {
    ...
    merged.paddtMaxWordsPerSegment = parseNumber(
      merged.paddtMaxWordsPerSegment,
      DEFAULT_PADDT_CONFIG.paddtMaxWordsPerSegment,
    );
  ...
  function applyDummyRowItemsStep(config, container, heightPerPage, currentHeight, debug) {
    ...
    if (remaining > 0) {
      ...
      if (itemHeight > 0) {
        ...
        if (debug) {
          console.log(
            `[printform]   inserted ${count} dummy_row_items (${count} x ${itemHeight}px = ${count * itemHeight}px)`,
          );
  ...
  function applyFooterSpacerWithDummyStep(config, container, heightPerPage, currentHeight, skipDummyRowItems, debug) {
    if (!config.insertFooterSpacerWithDummyRowItemWhileFormatTable || skipDummyRowItems) {
      if (debug) {
        console.log(
          `[printform] applyFooterSpacerWithDummyStep: SKIPPED (flag=${config.insertFooterSpacerWithDummyRowItemWhileFormatTable}, skipDummy=${skipDummyRowItems})`,
        );
      }
      return {
  ...
  function measureHeight(element) {
    ...
    const view =
      (element.ownerDocument && element.ownerDocument.defaultView) || (typeof window !== 'undefined' ? window : null);
  ...
  function createPageBreakDivider(extraClassNames) {
    ...
    const resolvedClassNames =
      typeof extraClassNames === 'string' && extraClassNames.trim()
        ? extraClassNames
        : globalScope2 && typeof globalScope2.__printFormDividerClassAppend === 'string'
          ? globalScope2.__printFormDividerClassAppend
          : '';
...
`);
  ...
  function attachRowTypeMethods(FormatterClass) {
    ...
    FormatterClass.prototype.shouldSkipDummyRowItemsForContext = function shouldSkipDummyRowItemsForContext(
      pageContext,
    ) {
      return Boolean(
        pageContext &&
  ...
  function attachRenderingMethods(FormatterClass) {
    FormatterClass.prototype.ensureFirstPageSections = function ensureFirstPageSections(
      container,
      sections,
      heights,
      logFn,
    ...
    FormatterClass.prototype.appendRepeatingSections = function appendRepeatingSections(
      container,
      sections,
      logFn,
      skipRowHeader,
    ...
    FormatterClass.prototype.registerPageNumberClone = function registerPageNumberClone(node) {
      ...
      if (this.showPhysicalPageNumber) {
        if (
          node.querySelector(
            '[data-physical-page-number], [data-physical-page-total], [data-physical-page-number-container]',
          )
        ) {
  ...
  function attachPaginationRenderMethods(FormatterClass) {
    ...
    FormatterClass.prototype.computeRepeatingHeightForPage = function computeRepeatingHeightForPage(
      sections,
      heights,
      skipRowHeader,
    ) {
    ...
    FormatterClass.prototype.renderRows = function renderRows(
      outputContainer,
      sections,
      heights,
      footerState,
      ...
      sections.rows.forEach((row, index) => {
        ...
        if (currentHeight === 0) {
          ...
          this.ensureFirstPageSections(container, sections, heights, logFn, pageContext.skipRowHeader);
          ...
          if (this.debug) {
            console.log(
              `[printform] Page ${this.currentPage} start: firstSectionHeight=${currentHeight}px, pageLimit=${pageContext.limit}px`,
            );
          }
        }
        DomHelpers.markAsProcessed(row, baseClass);
        if (row.classList.contains('tb_page_break_before')) {
          ...
          if (this.debug) {
            console.log(
              `[printform] Page ${this.currentPage} start: currentHeight=${currentHeight}px, limit=${pageContext.limit}px`,
            );
          }
          if (!isPtacRow) {
          ...
          if (this.debug) {
            console.log(
              `[printform]   row[${index}] height=${rowHeight}px, currentHeight=${measuredHeight}px, limit=${pageContext.limit}px`,
            );
          }
      ...
      if (this.debug) {
        console.log(
          `[printform] ===== renderRows END (page ${this.currentPage}, finalHeight=${currentHeight}px) =====`,
        );
      }
      return {
        currentHeight,
    ...
    FormatterClass.prototype.applyRemainderSpacing = function applyRemainderSpacing(
      container,
      heightPerPage,
      currentHeight,
      footerState,
  ...
  function attachPaginationFinalizeMethods(FormatterClass) {
    ...
    FormatterClass.prototype.finalizeDocument = function finalizeDocument(
      ...
      const repeatingHeight =
        renderState && Number.isFinite(renderState.repeatingHeight) ? renderState.repeatingHeight : 0;
      ...
      if (heightWithFinalFooters <= lastPageLimit) {
        ...
        this.applyRemainderSpacing(container2, lastPageLimit, heightWithFinalFooters, footerState, spacerTemplate, {
          skipDummyRowItems,
          repeatingHeight,
      ...
      this.applyRemainderSpacing(container, defaultHeightPerPage, finalPageStartHeight, footerState, spacerTemplate, {
  ...
  function createPrintformDebugSession({ enabled, formEl, config }) {
    ...
    const install = () => {
      ...
      try {
        ...
        if (view.visualViewport) {
          con.log(
            `[printform] visualViewport: ${safeSerialize({ width: view.visualViewport.width, height: view.visualViewport.height, scale: view.visualViewport.scale })}`,
          );
        }
    ...
    const appendPanel = (outputContainer, details) => {
      ...
      const formClass =
        formEl && typeof formEl.className === 'string'
          ? `.${formEl.className.split(/\s+/).filter(Boolean).join('.')}`
          : '';
